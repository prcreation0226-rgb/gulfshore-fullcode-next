			...
			<div className="px-4 md:px-8">
				...
				>
					...
					<div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
						<CarouselPrevious className="absolute flex w-10 h-10 md:w-12 md:h-12 !bg-accent text-white -left-1 md:-left-12 top-[76%] md:top-[76%] z-10 md:-translate-y-1/2 opacity-90 hover:opacity-100" />
						<CarouselNext className="absolute flex w-10 h-10 md:w-12 md:h-12 !bg-accent text-white -right-1 md:-right-12 top-[76%] md:top-[76%] z-10 md:-translate-y-1/2 opacity-90 hover:opacity-100" />
					</div>
				</Carousel>
			</div>
		</section>
