				...
				{imageArray.length ? (
					<Carousel
						...
						<div
							...
							<CarouselPrevious
								className="absolute left-0 top-1/2 -translate-y-1/2 z-20 pointer-events-auto cursor-pointer bg-white text-black hover:bg-white border-0 shadow-md h-9 w-9 flex opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300"
							/>
							<CarouselNext
								className="absolute right-0 top-1/2 -translate-y-1/2 z-20 pointer-events-auto cursor-pointer bg-white text-black hover:bg-white border-0 shadow-md h-9 w-9 flex opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-300"
							/>
						</div>
					</Carousel>
				) : (
