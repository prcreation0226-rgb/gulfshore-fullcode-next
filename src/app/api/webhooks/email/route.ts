...
// HTML Template for Simple AI Concierge Greeting Response (When user sends ONLY "hi" / "hello")
...
${baseUrl}`;
			...
			// BUY INTENT OR PROPERTY SEARCH (Always present property cards immediately!)
